$(document).ready(function(){
		$("#result-table").on("click", ".info-edit", function(){
			...
			$("#info-type-" + eventId).replaceWith(function(){
				return "<td id='info-type-" + eventId+"'><input value='"+$(this).html()+"'></input></td>";
			});
			...
			$("#info-date-" + eventId).replaceWith(function(){
				return "<td id='info-date-"+eventId+"'><input value='"+$(this).html()+"'></input></td>";
			});
			$("#info-time-" + eventId).replaceWith(function(){
				return "<td id='info-time-" + eventId+"'><input value='"+$(this).html()+"'></input></td>";
			});
			...
			$("#info-notes-" + eventId).replaceWith(function(){
				return "<td colspan='3' id='info-notes-"+eventId+"'><input value='"+$(this).html()+"'></input></td>";
			});
			
			//**********Done button tapped*******************************
			$("button#edit-button-" + eventId).on("click", function(){
				var type = $("td#info-type-"+eventId+">input").val();
				...
				var notes = $("td#info-notes-"+eventId+">input").val();
				...
				$("td#info-type-"+eventId+">input").replaceWith(function(){
					return $(this).val();
				});
				...
				$("td#info-notes-"+eventId+">input").replaceWith(function(){
					return $(this).val();
				});
